...
export class UsuarioController {
  ...
  async create(
    ...
    // Crear la clave
    let clave = this.servicioSeguridad.createTextoAleatorio(10);
    console.log(clave);
    // Cifrar la clave
  ...
  async identificarUsuario(
    ...
    if (usuario) {
      let codigo2fa = this.servicioSeguridad.createTextoAleatorio(5);
  ...
  @post('/verificar-2fa')
  @response(200, {
    description: "Validar un código por 2fa",
